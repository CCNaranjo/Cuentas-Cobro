        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <main class="flex-1 overflow-y-auto">
                <div class="p-6 max-w-6xl mx-auto">
                    ...
                    <div class="mb-6">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="text-right">
                                ...
                                @if ($cuentaCobro->estado === 'borrador') bg-gray-100 text-gray-700 @endif">
                    ...
                    <form action="{{ route('cuentas-cobro.update', $cuentaCobro->id) }}" method="POST"
                        id="formCuentaCobro">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" value="{{ $cuentaCobro->numero_cuenta_cobro }}" readonly
                                ...
                                <div>
                                    ...
                                    <input type="date" name="fecha_radicacion"
                                        value="{{ old('fecha_radicacion', $cuentaCobro->fecha_radicacion) }}" required
                                ...
                                <div>
                                    ...
                                    <input type="date" name="periodo_inicio"
                                        value="{{ old('periodo_inicio', $cuentaCobro->periodo_inicio) }}" required
                                ...
                                <div>
                                    ...
                                    <input type="date" name="periodo_fin"
                                        value="{{ old('periodo_fin', $cuentaCobro->periodo_fin) }}" required
                    ...
                    <!-- Archivos de la Cuenta de Cobro (FUERA DEL FORMULARIO PRINCIPAL) -->
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        <div class="flex justify-between items-center mb-6">
                            ...
                            @if (in_array($cuentaCobro->estado, ['borrador', 'en_correccion_supervisor', 'en_correccion_contratacion']))
                                <button type="button" onclick="abrirModalSubirArchivo()"
                                    class="bg-gradient-to-r from-primary to-primary-dark text-white font-semibold py-2 px-4 rounded-lg hover:shadow-lg transition-all flex items-center text-sm">
                                    ...
                                    <div
                                        ...
                                        <div class="flex items-start space-x-3">
                                            ...
                                            <div class="flex flex-col space-y-2">
                                                ...
                                                @if (in_array($cuentaCobro->estado, ['borrador', 'en_correccion_supervisor', 'en_correccion_contratacion']) &&
                                                        (Auth::user()->tienePermiso('ver-todas-cuentas', $cuentaCobro->contrato->organizacion_id) ||
                                                            $archivo->subido_por == Auth::id()))
                                                    <form
                                                        action="{{ route('cuentas-cobro.archivos.eliminar', ['cuentaCobro' => $cuentaCobro->id, 'archivo' => $archivo->id]) }}"
                                                        method="POST"
                                                        onsubmit="return confirm('¿Está seguro de que desea eliminar este archivo?')"
                                                        class="inline">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit" class="text-danger hover:text-red-700 p-1"
                                                            title="Eliminar">
                        ...
                        @else
                            <div class="text-center py-8 bg-gray-50 rounded-lg">
                                ...
                                <p class="text-sm text-gray-400 mt-1">Haga clic en "Subir Archivo" para agregar
                                    documentos</p>
                            </div>
                        @endif
                    </div>
        ...
        <div class="bg-white rounded-xl shadow-xl max-w-md w-full">
            <div class="p-6 border-b border-gray-200">
                <div class="flex justify-between items-center">
                    ...
                    <button type="button" onclick="cerrarModalSubirArchivo()" class="text-gray-400 hover:text-gray-600">
            ...
            <form action="{{ route('cuentas-cobro.archivos.subir', $cuentaCobro->id) }}" method="POST"
                enctype="multipart/form-data" id="formSubirArchivo">
                @csrf
                <div class="p-6 space-y-4">
                        ...
                        <div class="flex items-center justify-center w-full">
                            <label
                                ...
                                <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                    ...
                                    <p class="text-xs text-gray-400 mt-1">PDF, DOC, DOCX, XLS, XLSX, JPG, JPEG, PNG (Máx.
                                        10MB)</p>
                                </div>
                    ...
                    <button type="button" onclick="limpiarBorrador()"
                        class="text-blue-600 hover:text-blue-800 text-sm font-semibold ml-4">
                        Descartar borrador
                    </button>
                </div>
    ...
    @push('scripts')
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                // Configurar formulario de subida de archivos
            ...
            // Resto de las funciones existentes para items y cálculos...
            ...
            document.getElementById('formSubirArchivo')?.addEventListener('submit', function(e) {
                ...
                setTimeout(() => {
                    // La redirección se manejará desde el controlador
                }, 100);
            });
        </script>
    @endpush
